...
export const courseLiveDetails: Record<string, any> = {
  ...
  '2': { // Commerce
    ...
    classTimeLabel: "5:00 PM - 6:30 PM",
    classTimeLabel2: "8:00 PM - 9:30 PM",
    class1LiveStreamUrl: 'https://d133w6ldrek1er.cloudfront.net/out/v1/4882f3a454494165b396de72e412d7aa/index_1.m3u8',
    class2LiveStreamUrl: 'https://d133w6ldrek1er.cloudfront.net/out/v1/49856fa811d3403facbfba24d0db04ab/index_1.m3u8',
    class1Visible: true,
    class2Visible: true,
  ...
  '4': { // Aarambh (Class 9)
    ...
    class2LiveStreamUrl: 'https://d133w6ldrek1er.cloudfront.net/out/v1/f15d86916b1f404baeb09967b920d86a/index_4.m3u8', 
    class1Visible: true,
    class2Visible: true,
    class1Times: (now: Date) => getDailyClassTimes(now, 17, 0, 90),
    class2Times: (now: Date) => getDailyClassTimes(now, 20, 0, 90),
