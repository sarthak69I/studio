  ...
  'Mathematics': [
    {
      ...
      lectures: [
        ...
        { id: 'L2', title: 'Real Numbers L2', notesLink: `${aarambhBasePath}/mathematics/${slugify('R. Number')}/notes/L2.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L3', title: 'Real Numbers L3', notesLink: `${aarambhBasePath}/mathematics/${slugify('R. Number')}/notes/L3.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L4', title: 'Real Numbers L4', notesLink: `${aarambhBasePath}/mathematics/${slugify('R. Number')}/notes/L4.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L5', title: 'Real Numbers L5', notesLink: `${aarambhBasePath}/mathematics/${slugify('R. Number')}/notes/L5.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L6', title: 'Real Numbers L6', notesLink: `${aarambhBasePath}/mathematics/${slugify('R. Number')}/notes/L6.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
      ]
    },
    {
      name: 'Polynomials',
      lectures: [
        { id: 'L1', title: 'Polynomials L1', notesLink: `${aarambhBasePath}/mathematics/${slugify('Polynomials')}/notes/L1.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L2', title: 'Polynomials L2', notesLink: `${aarambhBasePath}/mathematics/${slugify('Polynomials')}/notes/L2.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L3', title: 'Polynomials L3', notesLink: `${aarambhBasePath}/mathematics/${slugify('Polynomials')}/notes/L3.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L4', title: 'Polynomials L4', notesLink: `${aarambhBasePath}/mathematics/${slugify('Polynomials')}/notes/L4.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L5', title: 'Polynomials L5', notesLink: `${aarambhBasePath}/mathematics/${slugify('Polynomials')}/notes/L5.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L6', title: 'Polynomials L6', notesLink: `${aarambhBasePath}/mathematics/${slugify('Polynomials')}/notes/L6.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
      ]
    },
    {
      name: 'Linear Equations',
      lectures: [
        { id: 'L1', title: 'Linear Equations L1', notesLink: `${aarambhBasePath}/mathematics/${slugify('Linear Equations')}/notes/L1.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L2', title: 'Linear Equations L2', notesLink: `${aarambhBasePath}/mathematics/${slugify('Linear Equations')}/notes/L2.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L3', title: 'Linear Equations L3', notesLink: `${aarambhBasePath}/mathematics/${slugify('Linear Equations')}/notes/L3.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L4', title: 'Linear Equations L4', notesLink: `${aarambhBasePath}/mathematics/${slugify('Linear Equations')}/notes/L4.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L5', title: 'Linear Equations L5', notesLink: `${aarambhBasePath}/mathematics/${slugify('Linear Equations')}/notes/L5.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L6', title: 'Linear Equations L6', notesLink: `${aarambhBasePath}/mathematics/${slugify('Linear Equations')}/notes/L6.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L7', title: 'Linear Equations L7', notesLink: `${aarambhBasePath}/mathematics/${slugify('Linear Equations')}/notes/L7.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L8', title: 'Linear Equations L8', notesLink: `${aarambhBasePath}/mathematics/${slugify('Linear Equations')}/notes/L8.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
      ]
    },
    {
      name: 'Trigonometry',
      lectures: [
        { id: 'L1', title: 'Trigonometry L1', notesLink: `${aarambhBasePath}/mathematics/${slugify('Trigonometry')}/notes/L1.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L2', title: 'Trigonometry L2', notesLink: `${aarambhBasePath}/mathematics/${slugify('Trigonometry')}/notes/L2.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L3', title: 'Trigonometry L3', notesLink: `${aarambhBasePath}/mathematics/${slugify('Trigonometry')}/notes/L3.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L4', title: 'Trigonometry L4', notesLink: `${aarambhBasePath}/mathematics/${slugify('Trigonometry')}/notes/L4.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L5', title: 'Trigonometry L5', notesLink: `${aarambhBasePath}/mathematics/${slugify('Trigonometry')}/notes/L5.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L6', title: 'Trigonometry L6', notesLink: `${aarambhBasePath}/mathematics/${slugify('Trigonometry')}/notes/L6.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L7', title: 'Trigonometry L7', notesLink: `${aarambhBasePath}/mathematics/${slugify('Trigonometry')}/notes/L7.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
        { id: 'L8', title: 'Trigonometry L8', notesLink: `${aarambhBasePath}/mathematics/${slugify('Trigonometry')}/notes/L8.pdf`, videoEmbedType: 'hls', videoEmbedUrl: '' },
      ]
    }
  ],
};  
