...
const courseLiveDetails: Record<string, LiveClassData> = {
  '1': { // Science
    ...
    '2': { // Commece
      ...
      class1Subject: "MATHS",
      class2Subject: "Accounts",
      class1LiveStreamUrl: `${newStreamPlayerBaseUrl}${encodeURIComponent('https://dga9kme080o0w.cloudfront.net/out/v1/5c7cfedca3df4fc99ea383b5f2e6a7a8/index_4.m3u8')}`,
      class2LiveStreamUrl: `${newStreamPlayerBaseUrl}${encodeURIComponent('https://d133w6ldrek1er.cloudfront.net/out/v1/ca26d3ff165b4e07a358b55f5455cd98/index_4.m3u8')}`,
      class1Visible: true,
      class2Visible: true,
  },
