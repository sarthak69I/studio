...
const courseLiveDetails: Record<string, LiveClassData> = {
  '1': { // Science
    ...
    class1LiveStreamUrl: `${newStreamPlayerBaseUrl}${encodeURIComponent('https://www.youtube.com/live/YGNnXZdGPmQ?si=IUiZ1-oCaa85jJ-9')}`,
    ...
    '2': { // Commece
      ...
      class1LiveStreamUrl: `${newStreamPlayerBaseUrl}${encodeURIComponent('https://www.youtube.com/live/2ySarCO_f1M?si=1OIYRCyH6Mw9vudP')}`,
  ...
  '3': { // Aarambh (Foundation Class 10)
    ...
    class2Subject: "",
    class1LiveStreamUrl: `${newStreamPlayerBaseUrl}${encodeURIComponent('https://www.youtube.com/live/mYASBrBUoYQ?si=eXUHp3XIaBnEuGzd')}`,
