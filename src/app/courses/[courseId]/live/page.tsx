...
const courseLiveDetails: Record<string, LiveClassData> = {
  '1': { // Science
    ...
    class1LiveStreamUrl: `${newStreamPlayerBaseUrl}${encodeURIComponent('https://dga9kme080o0w.cloudfront.net/out/v1/ac361b0bc5c84abba22ce98a674f14a3/index_1.m3u8')}`,
    ...
    '2': { // Commece
      ...
      class1LiveStreamUrl: `${newStreamPlayerBaseUrl}${encodeURIComponent('https://d133w6ldrek1er.cloudfront.net/out/v1/4882f3a454494165b396de72e412d7aa/index_1.m3u8')}`,
      class2LiveStreamUrl: `${newStreamPlayerBaseUrl}${encodeURIComponent('https://d133w6ldrek1er.cloudfront.net/out/v1/49856fa811d3403facbfba24d0db04ab/index_1.m3u8')}`,
      class1Visible: true,
      class2Visible: true,
  },
  ...
  '4': { // Aarambh (Foundation Class 9)
    ...
    class2LiveStreamUrl: `${newStreamPlayerBaseUrl}${encodeURIComponent('https://d133w6ldrek1er.cloudfront.net/out/v1/49856fa811d3403facbfba24d0db04ab/index_4.m3u8')}`, 
    class1Visible: false,
    class2Visible: true,
  }
};
